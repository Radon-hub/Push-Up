package org.radon.pushup.features.analytics.infrastructure.repository;
...
public class AnalyticsJDBCRepository {
    ...
    public AnalyticsJDBCRepository(@Qualifier("clickHouseJdbcTemplate") JdbcTemplate jdbcTemplate, ObjectMapper objectMapper) {
